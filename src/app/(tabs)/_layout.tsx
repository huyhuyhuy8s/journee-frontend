...
const TabLayout = () => {
  ...
  return (
    <NativeTabs minimizeBehavior='onScrollDown' labelStyle={{color: colors.text, fontFamily: 'Whyte'}}
                tintColor={colors.secondary}
                iconColor={colors.text} backgroundColor={colors.background} indicatorColor={colors.accent}
