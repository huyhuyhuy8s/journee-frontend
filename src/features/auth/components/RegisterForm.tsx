    ...
    <View style={styles.form}>
      <View style={styles.inputContainer}>
        <Text style={styles.label}>
          Email <Text style={styles.labelHighlight}>*</Text>
        </Text>
        <TextInput
      ...
      <View style={styles.inputContainer}>
        <Text style={styles.label}>
          Username <Text style={styles.labelHighlight}>*</Text>
        </Text>
        <TextInput
      ...
      <View style={styles.inputContainer}>
        <Text style={styles.label}>
          Password <Text style={styles.labelHighlight}>*</Text>
        </Text>
        <TextInput
      ...
      <View style={styles.inputContainer}>
        <Text style={styles.label}>
          Confirm Password <Text style={styles.labelHighlight}>*</Text>
        </Text>
        <TextInput
